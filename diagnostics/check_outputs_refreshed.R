...
manifest <- list(
  ...
  "12b" = c(dat("12b_withgammas_monotone.rds"),
            dat("12b_data_for_counterfactuals_monotone.rds"),
            tab("12b_validate_corr_monotone.tex"),
            fig(c("12b_gamma_dist_monotone.png",
                  "12b_marginal_cut_monotone.png", "12b_marginal_color_monotone.png",
                  "12b_marginal_other3_monotone.png", "12b_bivariate_cut_color_monotone.png",
                  "12b_bivariate_cut_other3_monotone.png", "12b_bivariate_color_other3_monotone.png"))),
