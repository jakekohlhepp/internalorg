#' =============================================================================
#' STEP 11: Productivity-Weighted Wage-Shock Substitution Patterns
#' =============================================================================
#' Companion to step 10: computes 1% wage-shock substitution elasticities on
#' productivity rather than headcount (rowSums of B * skill).
#'
#' Inputs:
...
cat(output, file = file.path("results","out","tables","11_substitute_prod.tex"))
