...
| 5b | `06b_wage_identification.R` | `results/data/06b_wage_identification.rds`, `results/out/tables/06b_wage_eigenvalues.tex`, `results/out/tables/06b_wage_perturbation.tex` | Wage-stage Hessian eigenvalues and perturbation diagnostic. |
...
`19_counterfactual_figures.R` retain the `05_07_*` prefix so the JMP draft
