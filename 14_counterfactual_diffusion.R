## Management diffusion counterfactual.
## Stores equilibrium wages and per-firm productivity panels under both the
## reorganization and the reallocation-only response.
source("config.R")
...
save_counterfactual_rds(
  ...
  legacy_filename = "14_wages_diffusion.rds"
)
...
save_counterfactual_rds(
  ...
  legacy_filename = "14_prod_diffusion.rds"
)
