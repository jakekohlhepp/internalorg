...
for (cnty in c('36061','17031', '6037') ){
  for (qy in 2021.2 ){
    ...
    quad_wages<-BBsolve(as.numeric(initial_wages[county==cnty & quarter_year==qy, c("w1", "w2", "w3", "w4", "w5")]),
                        solve_reloc, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=1, M=c(10,20,5,50)))
...
for (cnty in c('36061','17031') ){
  for (qy in 2021.2 ){
    ...
    res_wages[quarter_year==qy & county==cnty & sol_type=="reorg", c("w1", "w2", "w3", "w4", "w5"):= as.list(quad_wages$zero)]
    res_wages[quarter_year==qy & county==cnty& sol_type=="reorg", fval:=quad_wages$fnorm]
...
for (cnty in c('6037') ){
  for (qy in 2021.2 ){
    ...
    quad_wages<-BBsolve(as.numeric(res_wages[county==cnty & quarter_year==qy &sol_type=="realloc", c("w1", "w2", "w3", "w4", "w5")]),
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=500000, M=c(10,2,200,15,15)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=200000, M=c(10,2,200,15,15)))
    
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=100000, M=c(10,100,15,5,20)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=50000, M=c(10,100,15,5,20)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=40000, M=c(10,100,15,5,20)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=30000, M=c(10,100,15,5,20)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=20000, M=c(10,100,15,5,20)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=10000, M=c(10,100,15,5,20)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=5000, M=c(10,100,15,5,20)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=1000, M=c(10,100,15,5,20)))
    quad_wages<-broyden(solve_wages, quad_wages$par,maxiter=10000 )
    quad_wages<-BBsolve(quad_wages$zero,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=1, M=c(10,100,15,5,20)))
...
saveRDS(res_wages, "analysis_final/data/05_03_wages_salestax.rds")
...
saveRDS(prod_data_new, "analysis_final/data/05_03_prod_salestax.rds")
...
saveRDS(prod_data_new, "analysis_final/data/05_03_prod_initial.rds")
