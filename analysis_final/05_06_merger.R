...
for (cnty in c('36061','17031', '6037') ){
  for (qy in 2021.2 ){
    ...
    quad_wages<-BBsolve(as.numeric(initial_wages[county==cnty & quarter_year==qy, c("w1", "w2", "w3", "w4", "w5")]),
                        solve_reloc, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=1, M=c(100,10,20,5,50)))
...
for (cnty in c('36061','17031') ){
  for (qy in 2021.2 ){
    print(paste("*******",cnty, qy, " -  First Try"))
    quad_wages<-BBsolve(as.numeric(initial_wages[county==cnty & quarter_year==qy , c("w1", "w2", "w3", "w4", "w5")]),
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=10000, M=c(10,100,20,5,50)))
    quad_wages<-broyden(solve_wages, quad_wages$par,maxiter=1000 )
    quad_wages<-BBsolve(quad_wages$zero,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=1, M=c(10,100,20,5,50)))
...
for (cnty in c('6037') ){
  for (qy in 2021.2 ){
    ...
    quad_wages<-BBsolve(as.numeric(res_wages[county==cnty & quarter_year==qy & sol_type=="realloc", c("w1", "w2", "w3", "w4", "w5")]),
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=100000, M=c(10,100,20,5,50)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=TRUE, noimp=200, tol=50000, M=c(10,100,20,5,50)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=40000, M=c(10,100,20,5,50)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=30000, M=c(10,100,20,5,50)))
    quad_wages<-BBsolve(quad_wages$par,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=20000, M=c(10,100,20,5,50)))
    quad_wages<-broyden(solve_wages, quad_wages$par,maxiter=1000 )
    quad_wages<-BBsolve(quad_wages$zero,
                        solve_wages, control=list(maxit=10000,trace=TRUE, NM=FALSE, noimp=200, tol=1, M=c(10,100,20,5,50)))
    res_wages[quarter_year==qy & county==cnty & sol_type=="reorg", c("w1", "w2", "w3", "w4", "w5"):= as.list(quad_wages$par)]
...
saveRDS(res_wages, "analysis_final/data/05_06_wages_merger.rds")
...
saveRDS(prod_data_new, "analysis_final/data/05_06_prod_merger.rds")
