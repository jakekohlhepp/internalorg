...
## chair renters
chairrenter <- fread("C:/Users/jakek/jmp_dont_backup/20201204_chair_renters/staff_renters.csv")
...
top <- fread("C:/Users/jakek/jmp_dont_backup/20200909_raw/Marketing Intern Data/x00.csv")
files<-list.files(path="C:/Users/jakek/jmp_dont_backup/20200909_raw/Marketing Intern Data/",pattern = "*.csv")
tip_data1 <- rbindlist(lapply(paste0("C:/Users/jakek/jmp_dont_backup/20200909_raw/Marketing Intern Data/",files[-1]), fread))
names(tip_data1)<-names(top)
tip_data1<-rbind(tip_data1, top)
rm(top)
# only 5 obs with tips - clearly some issue with this.

tip_data2<-fread('C:/Users/jakek/jmp_dont_backup/20201214_tip_more/bi_tip_lines_2017-2020.csv')

tip_data3<-fread('C:/Users/jakek/jmp_dont_backup/20210809_alldata_refresh_withzip/tip_amount_export.csv')
...
product_data1<-fread('C:/Users/jakek/jmp_dont_backup/20210809_alldata_refresh_withzip/product_sales_export.csv')

product_data2<-fread('C:/Users/jakek/jmp_dont_backup/2017_2020_product_sales/2017_2020_product_sales.csv')
...
ggsave("analysis_final/out/figures/01_01_sindex_hist_byemps.png", width=4, height=4, units="in")
  ...
  etable(res0, res1,res2,res3,res4,res5,res6, fitstat=~r2,keep="!Constant",dict=c(county="County",std_rev_labor = "Revenue per Minute (standardized)", std_sindex="S-Index", location_zip="Zip" ,quarter_year="Quarter-Year", emps="Firm Size",
  ...
  etable( res1,res2,res3, fitstat=~r2,keep="!Constant",dict=c(std_rev_cust = "Revenue per Customer", std_sindex="S-Index", location_zip="Zip" ,quarter_year="Quarter-Year", emps="Firm Size",
                                                                                          task_mix_2="Color Task Mix",task_mix_3="Blowdry Task Mix",
                                                                                          task_mix_4="Admin. Task Mix", task_mix_5="Nail Task Mix", location_id="Establishment",
  ...
  etable(res0, res1,res2,res3,res4,res5, fitstat=~r2,keep="!Constant",dict=c(std_rev_labor = "Revenue per Minute", std_multi_rate="Teamwork", location_zip="Zip" ,quarter_year="Quarter-Year", emps="Firm Size",
                                                                             task_mix_2="Color Task Mix",task_mix_3="Blowdry Task Mix",
                                                                             task_mix_4="Admin. Task Mix", task_mix_5="Nail Task Mix", location_id="Establishment"),
  ...
  etable(res0, res1,res2,res3,res4,res5,res6, fitstat=~r2,keep="!Constant",dict=c(std_cust = "Customer Count", std_sindex="S-Index", location_zip="Zip" ,quarter_year="Quarter-Year", emps="Firm Size",
                                                                             task_mix_2="Color Task Mix",task_mix_3="Blowdry Task Mix",
                                                                             task_mix_4="Admin. Task Mix", task_mix_5="Nail Task Mix", location_id="Establishment",
