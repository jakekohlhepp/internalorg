...
g<-function(parms, x){
  ...
  w2<-c(parms[10],parms[11],parms[12],parms[13], parms[14], parms[15])
  w3<-c(parms[16],parms[17],parms[18],parms[19],parms[20],parms[21])
  w4<-c(parms[22],parms[23],parms[24],parms[25],parms[26],parms[27] )
  ut1<-parms[28]
  ut2<-parms[29]
  ut3<-parms[30]
  ct1<-parms[31]
