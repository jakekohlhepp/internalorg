...
starting<-c(starting, starting[-c(10:14)])
...
save(res_store, innertol, outertol, wage_bound,estim_sample, estim_matrix, file="data/01_05_progress.RData")
...
save(res_store, innertol, outertol,tau, wage_bound,estim_sample, estim_matrix, file="data/01_05_final_joint.RData")
