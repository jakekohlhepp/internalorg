...
firm_quarter[,round_resid_s_index:=floor(r_sindex/0.1)*0.1]
firm_quarter[,round_s_index:=floor(s_index/0.1)*0.1]
...
ggplot(tgc, aes(x=round_s_index, y=tot_duration)) + 
  ...
  geom_line(size=1) +
  geom_point(shape=21, size=3, fill="white")+ theme_bw(base_size=22)+
  xlab("Organization Complexity") + ylab("Total Labor Minutes")
...
ggplot(tgc, aes(x=round_s_index, y=cust_price)) + 
  ...
  geom_line(size=1) +
  geom_point(shape=21, size=3, fill="white")+ theme_bw(base_size=22)+
  xlab("Organization Complexity") + ylab("Revenue per Customer (Price)")
...
ggplot(tgc, aes(x=round_resid_s_index, y=r_price)) + 
  ...
  geom_line(size=1) +
  geom_point(shape=21, size=3, fill="white")+ theme_bw(base_size=22)+
  xlab("Residualized Organization Complexity") + ylab("Residualized Revenue per Customer (Price)")
...
ggplot(tgc, aes(x=round_s_index, y=return_rate)) + 
  ...
  geom_line(size=1) +
  geom_point(shape=21, size=3, fill="white")+ theme_bw(base_size=22)+
  xlab("Organization Complexity") + ylab("% Visits Customer Returns")
...
ggplot(tgc, aes(x=round_resid_s_index, y=r_return_rate)) + 
  ...
  geom_line(size=1) +
  geom_point(shape=21, size=3, fill="white")+ theme_bw(base_size=22)+
  xlab("Residualized Organization Complexity") + ylab("Residualized % Visits Customer Returns")
