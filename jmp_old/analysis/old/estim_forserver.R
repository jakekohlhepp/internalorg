...
estim_sample<-firm_quarter[quarter_year %between% c(2019.2, 2020.1) & county %in% c(6037)]
...
save(outgmm1,estim_sample, estim_matrix, starting, file="02_01_est_res_la_201902-2020-01.RData")
