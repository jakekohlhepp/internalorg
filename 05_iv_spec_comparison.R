...
#' Tables produced
#' ---------------
#'   Table 1 (05_standard_iv_comparison.tex): standard logit, 4 columns crossing
...
#'
#'   Table 2 (05_standard_hausman_fe_comparison.tex): standard logit with the
...
if (length(missing_packages) > 0) {
  stop("Missing required package(s): ", paste(missing_packages, collapse = ", "),
       "\nInstall them before running 05_iv_spec_comparison.R.")
}
...
table1_output_path <- "results/out/tables/05_standard_iv_comparison.tex"
...
table2_output_path <- "results/out/tables/05_standard_hausman_fe_comparison.tex"
