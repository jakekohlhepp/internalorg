...
firm_quarter[,r_sindex:=resid(feols(s_index~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_price:=resid(feols(cust_price~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_rev:=resid(feols(revenue~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_visits:=resid(feols(cust_visits~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_duration:=resid(feols(tot_duration~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_cust:=resid(feols(cust_count~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_emp:=resid(feols(emps~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_return_rate:=resid(feols(return_rate~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
firm_quarter[,r_rev_per:=resid(feols(rev_per~task_mix2+task_mix3+task_mix4+task_mix5+task_mix6| county_na+quarter_year, firm_quarter))]
...
ggplot(data=firm_quarter, aes(x=task_mix3,y=task_mix5, color=task_mix6))+
  geom_point()+  xlab("% Time Extensions") + ylab("% Time Admin.")+ labs(color='% Time Other') 
ggsave("out/figures/00_01_firm_scatter_other.png", width=12, heigh=6, units="in")
...
res3<-feols(revenue~s_index+task_mix2+task_mix3+task_mix4+task_mix5+task_mix6 | quarter_year+county_na, data=firm_quarter)
...
res3<-feols(revenue~max_time+task_mix2+task_mix3+task_mix4+task_mix5+task_mix6 | quarter_year+county_na, data=firm_quarter)
...
res_rev<-feols(revenue~s_index+task_mix2+task_mix3+task_mix4+task_mix5+task_mix6 | quarter_year+county_na, data=firm_quarter)
res_emp<-feols(emps~s_index+task_mix2+task_mix3+task_mix4+task_mix5+task_mix6 | quarter_year+county_na, data=firm_quarter)
res_labor<-feols(tot_duration~s_index+task_mix2+task_mix3+task_mix4+task_mix5+task_mix6 | quarter_year+county_na, data=firm_quarter)
res_cust<-feols(cust_count~s_index+task_mix2+task_mix3+task_mix4+task_mix5+task_mix6 | quarter_year+county_na, data=firm_quarter)
res_visits<-feols(cust_visits~s_index+task_mix2+task_mix3+task_mix4+task_mix5+task_mix6 | quarter_year+county_na, data=firm_quarter)
...
esttex(res_rev, res_emp,res_labor,res_cust,res_visits, fitstat=~r2,dict=c(revenue = "Revenue", s_index="Org. Complexity", loc_city_state="City" ,quarter_year="Quarter-Year",
                                                                          ...
                                                                          county_na="County"),
       cluster=firm_quarter$location_id,drop=c("task_mix2","task_mix3", "task_mix4", "task_mix5", "task_mix6"), file="out/tables/00_01_reg_size_sindex.tex", replace=TRUE, se="cluster",signifCode=c(`***`=0.001,`**`=0.01, `*`=0.05))
