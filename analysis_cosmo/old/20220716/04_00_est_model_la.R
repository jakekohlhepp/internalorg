...
for (counter in 1:50){
  ...
  save(res_store,counter, file="data/04_00_progress.RData")
}
...
save(maxrefine,estim_sample, estim_matrix, starting,innertol, outertol, file="data/04_00_est_res_la.RData")
