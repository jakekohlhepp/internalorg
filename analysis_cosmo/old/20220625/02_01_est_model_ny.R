...
pre_max<-gmm(g, x=estim_matrix, t0=coef(refine_more6), prewhite=0, type="twoStep",optfct="optim",wmatrix='ident',centeredVcov='TRUE',
                  control=list(abstol=1e-08,reltol=1e-08, trace=1, maxit=1000))
...
save(maxrefine,estim_sample, estim_matrix, starting,innertol, outertol, file="data/02_01_est_res_ny.RData")
