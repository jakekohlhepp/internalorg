...
source('small_gmm_objective_mod.R')
###############
...
starting<-c(readRDS('data/best_starting_ny.rds'),0)
###############
...
save(res_store, innertol, outertol,tau, wage_bound,estim_sample, estim_matrix, file="data/01_03_progress.RData")
...
save(res_store, innertol, outertol,tau, wage_bound,estim_sample, estim_matrix, file="data/01_03_final_ny.RData")
