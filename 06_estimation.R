...
## ---------------------------------------------------------------------------
## Production pass: extra-tight tolerances
## ---------------------------------------------------------------------------
## Two orders of magnitude tighter than the paper draft on every level.
## Coarse-stage tolerances are pinned to the same fine values so staged
## solving is effectively single-stage at the tightest setting.
CONFIG$innertol <- 1e-10
CONFIG$outertol <- 1e-8
CONFIG$obj_tol  <- 1e-6
CONFIG$coarse_innertol <- CONFIG$innertol
CONFIG$coarse_outertol <- CONFIG$outertol
message("Extra-tight tolerances active: innertol=", CONFIG$innertol,
