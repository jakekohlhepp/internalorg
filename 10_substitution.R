#' =============================================================================
#' STEP 10: Wage-Shock Substitution Patterns
#' =============================================================================
#' Computes 1% wage-shock substitution elasticities across skill sets and the
#' example expansion-path figures for representative salons.
#'
#' Inputs:
...
#'   - results/out/figures/10_middle_decreasing_count.png
#'   - results/out/figures/10_middle_decreasing_count_blank.png
#'   - results/out/figures/10_middle_non_mon{1,2,3}_count.png
#'   - results/out/figures/10_increasing_count.png
#' =============================================================================
...
cat(output, file = "results/out/tables/10_substitute.tex")
...
ggsave("results/out/figures/10_middle_decreasing_count.png", width=12, height=8, units="in")
...
ggplot(data=total_res[location_id=='03d9b605-d697-461a-abc4-b9fbc502fecc' & quarter_year==2020.1 & gamma<=800])+geom_line(aes(x=gamma, y=count_emp), color="white")+
  ylab("# Skill Sets Employed")+xlab("Coordination Cost Parameter")+theme_bw() + theme(axis.text = element_text(size = 14),text = element_text(size = 20))+ 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"))
ggsave("results/out/figures/10_middle_decreasing_count_blank.png", width=12, height=8, units="in")
...
ggsave("results/out/figures/10_middle_non_mon1_count.png", width=6, height=4, units="in")
...
ggsave("results/out/figures/10_middle_non_mon2_count.png", width=6, height=4, units="in")
...
ggsave("results/out/figures/10_middle_non_mon3_count.png", width=6, height=4, units="in")
...
ggsave("results/out/figures/10_increasing_count.png", width=6, height=4, units="in")
