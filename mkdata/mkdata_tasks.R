...
setwd('C:/Users/jakek/jmp_dont_backup/20200909_raw/Marketing Intern Data/')
top <- fread("x00.csv")
...
#### process 2021 pull.
setwd('C:/Users/jakek/jmp_dont_backup/20210809_alldata_refresh_withzip/')
...
setwd('C:/Users/jakek/jmp_dont_backup/data')
