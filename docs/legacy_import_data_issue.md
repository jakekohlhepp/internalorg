...
from a prior point-of-sale system when the salon migrated to Boulevard. These
...
list and the transition dates come from the monthly short-duration / Boulevard-
...
of Boulevard-native booking features" pattern. Across those 10 salons, the
...
### 2. Boulevard-native features turn on at the transition
...
Boulevard's booking system and would not exist in records imported from a
legacy POS.
...
3. Boulevard-native features (`prebooked`, `was_staff_requested`) turned on at
