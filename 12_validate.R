#' =============================================================================
#' STEP 12: Model Validation against Observed Staff-Task Distributions
#' =============================================================================
#' Compares model-implied B (employee time allocations) against raw observed
#' staff-task shares. Produces correlation table, marginal and bivariate density
#' plots, and the counterfactual-ready panel with internal B_i_j values.
#'
#' Inputs:
...
#'   - results/out/figures/12_marginal_cut.png
#'   - results/out/figures/12_marginal_color.png
#'   - results/out/figures/12_marginal_other3.png
#'   - results/out/figures/12_bivariate_cut_color.png
#'   - results/out/figures/12_bivariate_cut_other3.png
#'   - results/out/figures/12_bivariate_color_other3.png
#' =============================================================================
...
full_unsmoothed<-readRDS(file.path('results','data','09_withgammas.rds'))
...
saveRDS(full_unsmoothed, file.path('results','data','12_data_for_counterfactuals.rds'))
...
cat(output, file = file.path("results","out","tables","12_validate_corr.tex"))
...
ggplot(toplot)+geom_density(aes(x=job_1,color=group,fill=group, weight=emp_duration), position='identity',alpha=0.5)+
  ...
  theme_bw() + theme(axis.text = element_text(size = 14),text = element_text(size = 20))+ 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"))
ggsave(file.path("results","out","figures","12_marginal_cut.png"), width=6, height=4, units="in")
...
ggplot(toplot)+geom_density(aes(x=job_2,color=group,fill=group, weight=emp_duration), position='identity',alpha=0.5)+
  ...
  theme_bw() + theme(axis.text = element_text(size = 14),text = element_text(size = 20))+ 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"))
ggsave(file.path("results","out","figures","12_marginal_color.png"), width=6, height=4, units="in")
...
ggplot(toplot)+geom_density(aes(x=comb_3,color=group,fill=group, weight=emp_duration), position='identity',alpha=0.5)+
  ...
  theme_bw() + theme(axis.text = element_text(size = 14),text = element_text(size = 20))+ 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"))
ggsave(file.path("results","out","figures","12_marginal_other3.png"), width=6, height=4, units="in")
...
ggplot(toplot)+geom_density_2d(aes(x=job_1,y=job_2),bins=50,color="black")+
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"))+
  facet_wrap(~group)
ggsave(file.path("results","out","figures","12_bivariate_cut_color.png"), width=10, height=6, units="in")
...
ggsave(file.path("results","out","figures","12_bivariate_cut_other3.png"), width=10, height=6, units="in")
